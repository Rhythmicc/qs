...
const completionSpec: Fig.Spec = {
    ...
    subcommands: [{
        ...
        args: [
            ...
            {name: 'to', description: 'query currency', suggestions: currency_suggestions},
            {name: 'fr', description: 'aim currency (or default currency)', isOptional: true, suggestions: currency_suggestions}
        ]
    }, {
        name: 'zhihu',
        ...
        options: [
            ...
            {
                name: '-f',
                description: 'read magnet url in file',
