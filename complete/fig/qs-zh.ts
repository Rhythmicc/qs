...
const currency_suggestions = [
    'CLP', 'AED', 'CZK', 'THB', 'MYR', 'NZD', 'LBP', 'LAK', 'HUF', 'VND',
...
const completionSpec: Fig.Spec = {
    ...
    subcommands: [{
        ...
        args: [
            ...
            {name: 'to', description: '待查询币种', suggestions: currency_suggestions},
            {name: 'fr', description: '目标币种 (或默认币种)', isOptional: true, suggestions: currency_suggestions}
        ]
    }, {
        name: 'zhihu',
        description: '获取知乎日报'
        ...
        options: [
            ...
            {
                name: '-f',
                description: '读取文件中的magnet链接',
                args: {name: 'file', description: '文件', template: 'filepaths'}
            }
        ]
    }, {
        name: 'd2m',
